...
{!! Form::open(['url' => 'modalTambahSlide', 'method' => 'post', 'id' => 'formTambahSlide', 'files' => true, 'name' =>'tambahSlideform']) !!}
...
<script type="text/javascript">
    ...
    $("#btnSave").click(function(e){        
        var data = new FormData(document.forms.namedItem("tambahSlideform"));
        $('.form-control').prop('disabled', true);
        $.ajax({
            url         : 'modalTambahSlide',                                                       
            type        : 'post',
            data        : data,
            contentType : false,
            processData : false,
